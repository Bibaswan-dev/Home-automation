...
function Navbar() {
  ...
  return (
    <nav className="bg-[#eff8f3] shadow-md   py-2 z-30">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <Link href={"/"} className="flex flex-shrink-0 items-center">
              <h1 className="text-slate-700 font-semibold text-xl cursor-pointer">
               <span className="text-teal-500 "> Saurah</span>.<span>Finance</span>
              </h1>
            </Link>
      ...
      <Link href={'/Signup'} className="absolute top-6 bg-teal-500 text-white font-semibold md:text-lg rounded-full px-5 p-1 right-2 md:right-20 ">Login</Link>
    </nav>
  );
}
